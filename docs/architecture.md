...
| `CHDSharpEncoder` | Library | Companion *encoder* support: CRC16, SHA1, Deflate wrappers, V5 map compressor (`MapCompressor`, `Huffman16_8`), V5 header writer. Useful for writing CHDs; not required for reading. |
