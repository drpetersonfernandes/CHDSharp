...
public class ChdListIntegrationCollection { }
...
public class ChdListIntegrationTests
{
    ...
    public void FullVerification_MatchesChdman(string path)
    {
        if (path == null)
    ...
    public void RandomAccess_MatchesChdmanExtract(string path)
    {
        if (path == null)
